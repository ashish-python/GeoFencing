...
public final class Endpoints {
    ...
    public static String CHILD_FCM_TOKEN_UPDATE_URL = "http://192.168.1.153:80/safechild/update_child_fcm_token.php";
    */


    public static String SIGN_IN_URL = "http://155.246.76.17:3000/authenticateChild";
    public static String GET_CHILD_DATA_URL = "http://155.246.76.17:3000/childData";
    public static String LAST_KNOWN_LOCATION_URL = "http://155.246.76.17:3000/childLocationUpdate";
    public static String CHILD_FCM_TOKEN_UPDATE_URL = "http://155.246.76.17:3000/childFCMTokenUpdate";
    public static final String GEOFENCE_URL = "http://155.246.76.17:3000/childData";
    public static final String PUSH_NOTIFICATION_TO_PARENT_URL = "http://155.246.76.17:3000/geofenceEventTriggerNotification";
    public static final String SEND_EVENT_DATA_TO_SERVER_URL = "http://155.246.76.17:3000/saveGeofenceEventToServer";
    ...
    public static final String SEND_EVENT_DATA_TO_SERVER_TASK = "geofence_event_to_server";
